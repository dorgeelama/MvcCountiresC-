...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        //If the search text is empty and search by is "PersonName", it hsould return all persons
        [Fact]
        ...
        //First we will add few persons; and then we will serach based on person name with some search string. It should return the matching persons
        [Fact]
        ...
        public void UpdatePerson_PersonFullDetailsUpdation()
        {
            ...
            PersonAddRequest person_add_request = new PersonAddRequest() { PersonName = "John",
                CountryID = country_response_from_add.CountryID, Address = "Abc road", 
                                DateOfBirth = DateTime.Parse("2000-01-01"), Email = "abc@example.com", Gender = GenderOptions.Male, ReceiveNewsLetter = true };
        ...
        public void DeletePerson_ValidPersonID()
        {
            ...
            CountryResponse country_response_from_add = _countriesService.AddCountry(country_add_request);
            PersonAddRequest person_add_request = new PersonAddRequest() { PersonName = "Jones", Address = "address", CountryID = country_response_from_add.CountryID, 
                DateOfBirth = Convert.ToDateTime("2010-01-01"), Email = "jones@example.com", Gender = GenderOptions.Male, ReceiveNewsLetter = true };
            PersonResponse person_response_from_add = _personService.AddPerson(person_add_request);
